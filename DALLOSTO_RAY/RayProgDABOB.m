clf
clear all
load /Users/justindiamond/Documents/Documents/UW-APL/Research/Diamond_Ray/data_files/ssp
...
thtSBSP = lnchang;
% 
[Range,Depth,time,launch_angles] = eigenray_waveguide([thtDP thtSP thtBP thtBSP thtSBP-.5]-2,...
...
labels = arrayfun(@(x) sprintf('\\theta = %.2f°', x), launch_angles, 'UniformOutput', false);
legend(x, labels, 'Location','best');
